...
//                interactor->GetEventPosition()[1], 0, renderer);
//
//            double picked[3];
...
//    std::string inputFilename = "../test2.ima";
//    //reader.TakeReference(readerFactory->CreateImageReader2(inputFilename.c_str()));
//    reader->SetFileName(inputFilename.c_str());
//    reader->Update();
//
//    // Picker to pick pixels
//    vtkNew<vtkPointPicker> propPicker;
